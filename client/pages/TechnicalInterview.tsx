          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card>
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Prepare for real technical interviews with our AI interviewer that simulates mid-tier company processes
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <Card 
                    ...
                    onClick={() => startInterview('junior', ['algorithms', 'data-structures', 'problem-solving'])}
                  >
                    <CardHeader className="text-center">
                  ...
                  <Card 
                    className="cursor-pointer border-2 hover:border-primary/50 transition-colors"
                    onClick={() => startInterview('mid', ['system-design', 'algorithms', 'optimization', 'debugging'])}
                  >
                    <CardHeader className="text-center">
                  ...
                  <Card 
                    className="cursor-pointer border-2 hover:border-primary/50 transition-colors"
                    onClick={() => startInterview('senior', ['system-design', 'scalability', 'leadership', 'architecture'])}
                  >
                    <CardHeader className="text-center">
                ...
                <div className="text-center">
                  <p className="text-muted-foreground mb-4">
                    The interview will last 30-45 minutes and include live coding, problem-solving, and technical discussion.
                  </p>
        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-foreground">Technical Interview</h1>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <Badge variant={session.score && session.score >= 70 ? "default" : "secondary"}>
                            {session.score && session.score >= 70 ? "Good" : "Needs Improvement"}
                          </Badge>
                        </div>
                      </div>
                      <div>
